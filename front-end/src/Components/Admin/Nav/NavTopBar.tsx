...
const NavTopBar: React.FC <Props> = ({navLocation}) => {
    return (
    <>
                ...
                <nav>
                    ...
                    <ol className="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        <li className="leading-normal text-sm">
                            <a className="opacity-50 text-slate-700" href="javascript:;">Admin</a>
                        </li>
                        <li className="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']" aria-current="page">{navLocation}</li>
                    </ol>
                    <h6 className="mb-0 font-bold capitalize">{navLocation}</h6>
                </nav>
