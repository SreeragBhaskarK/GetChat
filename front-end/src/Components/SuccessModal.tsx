...
export const SuccessModal = ({ success, setSuccess }) => {
    const show = true
    return (
        <>
            {success && < div className="fixed inset-0 flex justify-center items-center overflow-y-auto overflow-x-hidden z-50">
                <div className="w-full max-w-md h-full md:h-auto p-4">
                    <div className="p-4 text-center bg-white rounded-lg shadow sm:p-5 dark:bg-gray-800 relative">
                        <button
                            type="button"
